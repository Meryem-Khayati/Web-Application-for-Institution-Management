...
export default function RefuserDemande() {
    ...
    function handleSubmit(e) {
        ...
        formData.append('subject', demandeinfo.suject);
        
        demandeServices.refuserDemande(id,formData)
            ...
            .catch(err => {console.log(err)
                setMessage("Erreur lors de la refusion de la demande");
                setIstrue(false)
