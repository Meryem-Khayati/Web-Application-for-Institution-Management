...
import CardSemestreEtudiant from './CardSemestreEtudiant';
import { useParams,useLocation } from 'react-router-dom';

export default function ListSemestresEtdEmploi() {
    ...
    useEffect(() => {
      ...
      const listSemestres = semestre.map(element=>{
        return <CardSemestreEtudiant key={element.id} id={element.id} nom={element.nom} />
      })
    ...
    return (
      ...
      <section className='admin-dashboard-cards'>
            <div>
                ...
                <h1>Cliquez sur une carte de semestre pour voir son emploi de temps</h1>
                </div>
